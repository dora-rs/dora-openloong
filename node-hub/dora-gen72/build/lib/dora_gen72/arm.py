...
RIGHT_ROBOT_IP = os.getenv("ROBOT_IP", "192.168.1.19")
LEFT_ROBOT_IP = os.getenv("ROBOT_IP", "192.168.1.20")
...
class robot_gen72:
    def __init__(self):
        ...
        right_connect=self.right_arm.rm_create_robot_arm(RIGHT_ROBOT_IP, 8080)
        left_connect= self.left_arm.rm_create_robot_arm(LEFT_ROBOT_IP, 8080)
        #---------------------------------right_arm init
